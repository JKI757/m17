// Package inet implements the M17 Internet client and stream datagrams.
package inet
...
import (
	...
	. "github.com/jancona/m17/pkg/protocol"
)
...
// Logger receives optional Internet-client events.
type Logger interface {
	Log(logType string, logSubtype string, addlArgs ...any)
}

func NewInetClient(name string, server string, port uint, module string, callsign string, dashLog Logger, packetHandler func(Packet) error, streamHandler func(StreamDatagram) error) (*InetClient, error) {
